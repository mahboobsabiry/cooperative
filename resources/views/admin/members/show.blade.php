        ...
        <div class="page-header">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.members.index') }}">{{ __('مضامین') }}</a>
                    </li>
            ...
            <div class="btn btn-list">
                <div class="d-flex">
                    <div class="mr-2">
                        ...
                        @include('admin.members.ed')
                    </div>
                    <div class="mr-2">
                        <!-- Edit -->
                        <a class="btn ripple bg-dark btn-sm text-white"
                           href="{{ route('admin.members.edit', $subject->id) }}">
                            @lang('global.edit')
            ...
            <div class="col-md-12">
                ...
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <!-- Table Title -->
                        <div>
                            <h6 class="card-title font-weight-bold mb-1">{{ __('تعداد کتب این مضمون') }}
                                ({{ count($subject->books) }})</h6>
                        ...
                        <div class="table-responsive mt-2">
                            <table
                                class="table table-bordered export-table border-top key-buttons display text-nowrap w-100">
                                <thead>
                                <tr>
                                ...
                                @foreach($subject->books as $book)
                                    <tr>
                                        ...
                                        <!-- Image -->
                                        <td><img
                                                src="{{ $user->image ?? asset('assets/images/deposits/no-image.png') }}"
                                                width="50" class="rounded-1"></td>
                                        <!-- Name -->
                                        <td>
                                            <a href="{{ route('admin.deposits.show', $book->id) }}">{{ $book->name }}</a>
                                        </td>
