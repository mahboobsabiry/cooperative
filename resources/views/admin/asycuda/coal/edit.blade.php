...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <!-- Breadcrumb -->
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">ویرایش جواز شرکت</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('admin.dashboard.dashboard')</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.asycuda.coal.index') }}">جواز شرکت ها</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.asycuda.coal.show', $cal->id) }}">@lang('global.details')</a></li>
                    <li class="breadcrumb-item active" aria-current="page">ویرایش جواز شرکت</li>
                </ol>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form Title -->
                        <div>
                            <h6 class="card-title mb-1">ویرایش جواز شرکت</h6>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group @error('company_name') has-danger @enderror">
                                        ...
                                        <input type="text" id="company_name" class="form-control @error('company_name') form-control-danger @enderror" name="company_name" value="{{  $cal->company_name ?? old('company_name') }}" required>
                                    ...
                                    <div class="form-group @error('company_tin') has-danger @enderror">
                                        ...
                                        <input type="number" id="company_tin" class="form-control @error('company_tin') form-control-danger @enderror" name="company_tin" value="{{ $cal->company_tin ?? old('company_tin') }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group @error('owner_phone') has-danger @enderror">
                                        ...
                                        <input type="tel" id="owner_phone" class="form-control @error('owner_phone') form-control-danger @enderror" name="owner_phone" value="{{ $cal->owner_phone ?? old('owner_phone') }}">
                                    ...
                                    <div class="form-group @error('address') has-danger @enderror">
                                        ...
                                        <input type="text" id="address" class="form-control @error('address') form-control-danger @enderror" name="address" value="{{ $cal->address ?? old('address') }}" required>
                                    ...
                                    <div class="form-group @error('info') has-danger @enderror">
                                        ...
                                        <textarea name="info" class="form-control @error('info') form-control-danger @enderror">{{ $cal->info ?? old('info') }}</textarea>
