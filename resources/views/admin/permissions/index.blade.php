                            ...
                            <table id="exportexample" class="table table-bordered border-t0 key-buttons text-nowrap w-100" >
                                ...
                                @foreach($permissions as $permission)
                                    <tr>
                                        ...
                                        <td>{{ date_format($permission->created_at, 'Y-F-d / h:i A') }}</td>
                                        <td>
                                            <!-- Edit -->
                                            @can('permission_edit')
                                                <a class="modal-effect btn btn-sm ripple btn-info" data-effect="effect-sign" data-toggle="modal" href="#edit_record{{ $permission->id }}">
                                            ...
                                            @can('permission_delete')
                                                <a class="modal-effect btn btn-sm ripple btn-danger" data-effect="effect-sign" data-toggle="modal" href="#delete_record{{ $permission->id }}">
