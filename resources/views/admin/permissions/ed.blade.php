    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-header">
                <h6 class="modal-title">@lang('pages.permissions.editPermission') <i class="fe fe-edit"></i></h6>
            ...
            <form method="post" action="{{ route('admin.permissions.update', $permission->id) }}" class="" data-parsley-validate="">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group @error('name') has-danger @enderror">
                        ...
                        <input type="text" id="name" class="form-control @error('name') form-control-danger @enderror" name="name" value="{{ $permission->name ?? old('name') }}" placeholder="@lang('form.name')" required>
