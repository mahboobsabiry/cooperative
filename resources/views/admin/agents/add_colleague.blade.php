        ...
        <div class="page-header">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.agents.show', $agent->id) }}">@lang('global.details')</a></li>
                ...
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div class="">
                            ...
                            <!-- Form -->
                            <form method="post" action="{{ route('admin.agents.add_agent_colleague', $agent->id) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <!-- Name -->
