...
<!-- Title -->
@section('title', config('app.name') . ' ~ ' . trans('global.details'))
<!-- Extra Styles -->
@section('extra_css')
    <!---DataTables css-->
        ...
        <div class="page-header">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.exit-door.index') }}">@lang('global.all')</a></li>
            ...
            <div class="btn btn-list">
                ...
                @include('admin.exit-door.delete')

                <!-- Edit -->
                <a class="btn ripple btn-dark btn-sm" href="{{ route('admin.exit-door.edit', $item->id) }}">
                    <i class="fe fe-edit"></i> @lang('global.edit')
                </a>

                <!-- Add New -->
                <a class="btn ripple btn-primary btn-sm" href="{{ route('admin.exit-door.create') }}" target="_blank">
                            ...
                            <div class="table-responsive ">
                                <table class="table row table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        @if($item->exit_type == 0)
                                            <td>@lang('pages.exitDoor.transitGoods')</td>
                                        @elseif($item->exit_type == 1)
                                            <td>@lang('pages.exitDoor.exportGoods')</td>
                                        @elseif($item->exit_type == 2)
                                            <td>@lang('pages.exitDoor.emptyVehicles')</td>
                                        @elseif($item->exit_type == 3)
                                            <td>@lang('pages.exitDoor.rejectedGoods')</td>
                                        @elseif($item->exit_type == 0 && $item->is_returned == 1)
                                            <td>@lang('pages.exitDoor.returnedTransit')</td>
                                        @elseif($item->exit_type == 1 && $item->is_returned == 1)
                                            <td>@lang('pages.exitDoor.returnedExport')</td>
                                        @endif
                                    </tr>
                                    </tbody>
                                </table>
                                        ...
                                        <div class="form-group bd-t pt-1">
                                            ...
                                            @if($item->is_returned == 1)
                                                <a class="is_returned" id="is_returned"
                                                   exit_type="{{ $item->id }}" href="javascript:void(0)">
...
@section('extra_js')
    ...
    @include('admin.exit-door.inc.scripts')
@endsection
