...
<!-- Title -->
@section('title', config('app.name') . ' ~ ' . trans('pages.exitDoor.returnedTransit'))
<!-- Extra Styles -->
@section('extra_css')
    <!---DataTables css-->
        ...
        <div class="page-header">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">@lang('pages.exitDoor.returnedTransit')</li>
                </ol>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card custom-card main-content-body-profile">
                    ...
                    <div class="nav main-nav-line mb-2">
                        ...
                        <a class="nav-link" href="{{ route('admin.ed.ex_returned') }}">
