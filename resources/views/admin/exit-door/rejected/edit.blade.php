        ...
        <div class="page-header">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.ed-rejected.show', $item->id) }}">@lang('global.details')</a></li>
                ...
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div class="">
                            ...
                            <!-- Form -->
                            <form method="post" action="{{ route('admin.ed-rejected.update', $item->id) }}" data-parsley-validate="">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
