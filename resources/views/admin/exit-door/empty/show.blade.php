    ...
    <div class="container-fluid">
        ...
        <div class="page-header">
            ...
            <div class="btn btn-list">
                ...
                @include('admin.exit-door.empty.delete')

                <!-- Edit -->
                <a class="btn ripple btn-dark btn-sm" href="{{ route('admin.ed-empty.edit', $item->id) }}">
                    <i class="fe fe-edit"></i> @lang('global.edit')
                </a>

                <!-- Add New -->
                <a class="btn ripple btn-primary btn-sm" href="{{ route('admin.ed-empty.create') }}" target="_blank">
