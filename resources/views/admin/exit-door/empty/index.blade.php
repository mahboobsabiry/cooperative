...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <!-- Breadcrumb -->
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">@lang('pages.exitDoor.emptyVehicles')</h2>
                <ol class="breadcrumb">
            ...
            <div class="btn btn-list">
                <!-- Add New -->
                <a class="btn ripple btn-primary" href="{{ route('admin.ed-empty.create') }}" target="_blank">
            ...
            <div class="col-lg-12">
                ...
                <div class="card custom-card main-content-body-profile">
                    ...
                    <div class="nav main-nav-line mb-2">
                        <a class="nav-link active" href="{{ route('admin.ed-empty.index') }}">
                        ...
                        <div class="tab-pane active">
                            ...
                            <div class="table-responsive mt-2">
                                <table id="exportexample"
                                    ...
                                    <tbody>
                                    @foreach($emptyVehicles as $item)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>
                                                <a href="{{ route('admin.ed-empty.show', $item->id) }}">{{ $item->c_name }}</a>
                                            </td>
