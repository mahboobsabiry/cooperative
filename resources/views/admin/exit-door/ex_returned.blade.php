...
<!-- Title -->
@section('title', config('app.name') . ' ~ ' . trans('pages.exitDoor.returnedExport'))
<!-- Extra Styles -->
@section('extra_css')
    <!---DataTables css-->
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <!-- Breadcrumb -->
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">@lang('pages.exitDoor.returnedExport')</h2>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">@lang('pages.exitDoor.returnedExport')</li>
                </ol>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card custom-card main-content-body-profile">
                    ...
                    <div class="nav main-nav-line mb-2">
                        <a class="nav-link" href="{{ route('admin.ed.tr_returned') }}">
                            @lang('pages.exitDoor.returnedTransit')
                        </a>
                        <a class="nav-link active" href="javascript:void(0)">
                            @lang('pages.exitDoor.returnedExport')
                        </a>
                    </div>
                                ...
                                <table id="exportexample"
                                    ...
                                    @foreach($items as $item)
                                        <tr>
                                            ...
                                            <td>{{ \Morilog\Jalali\CalendarUtils::strftime('Y-m-d', strtotime($item->return_date)) }}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
