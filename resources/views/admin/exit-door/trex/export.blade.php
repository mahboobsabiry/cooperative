...
<!-- Title -->
@section('title', config('app.name') . ' ~ ' . trans('pages.exitDoor.exportGoods'))
<!-- Extra Styles -->
@section('extra_css')
    <!---DataTables css-->
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <!-- Breadcrumb -->
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">@lang('pages.exitDoor.exportGoods')</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.dashboard') }}">@lang('admin.dashboard.dashboard')</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">@lang('pages.exitDoor.exportGoods')</li>
                </ol>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card custom-card main-content-body-profile">
                    ...
                    <div class="nav main-nav-line mb-2">
                        <a class="nav-link" href="{{ route('admin.ed-trex.index') }}">
                            @lang('pages.exitDoor.transitGoods')
                        </a>
                        <a class="nav-link active" href="{{ route('admin.ed-export.index') }}">
