...
<!-- Title -->
@section('title', trans('pages.finance.addBudget'))
<!-- Extra Styles -->
@section('extra_css')
    <!---Fileupload css-->
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <!-- Breadcrumb -->
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">@lang('pages.finance.addBudget')</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('admin.dashboard.dashboard')</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.finance.budgets.index') }}">@lang('admin.sidebar.budgets')</a></li>
                    <li class="breadcrumb-item active" aria-current="page">@lang('pages.finance.addBudget')</li>
                </ol>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="">
                            <!-- Form -->
                            <form method="post" action="{{ route('admin.finance.budgets.store') }}" data-parsley-validate="" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <!-- Title -->
                                        ...
                                        <div class="form-group @error('code') has-danger @enderror">
                                            ...
                                            <input type="text" id="code" class="form-control @error('code') form-control-danger @enderror" name="code" value="{{ old('code') }}" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group @error('amount') has-danger @enderror">
                                                    ...
                                                    <input type="number" id="amount" class="form-control @error('amount') form-control-danger @enderror" name="amount" value="{{ old('amount') }}" required>
