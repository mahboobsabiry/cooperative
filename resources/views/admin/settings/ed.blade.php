            ...
            <form method="post" action="{{ route('admin.settings.update', $setting->id) }}" class="" data-parsley-validate="">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group @error('value') has-danger @enderror">
                        <label class="form-label">@lang('form.value'): <span class="tx-danger">*</span></label>
                        <textarea id="value" class="form-control @error('value') form-control-danger @enderror" name="value" placeholder="@lang('form.value')" required>{{ $setting->value ?? '' }}</textarea>
