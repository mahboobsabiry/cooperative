        ...
        <div class="page-header">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.hostel.index') }}">@lang('pages.hostel.hostel')</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.hostel.show', $hostel->id) }}">@lang('global.details')</a></li>
            ...
            <div class="btn btn-list">
                <!-- Back -->
                <a class="btn btn-orange btn-sm btn-with-icon" href="{{ route('admin.hostel.index') }}">
                    @lang('global.back')
                ...
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div class="">
                            ...
                            <!-- Form -->
                            <form method="post" action="{{ route('admin.hostel.update', $hostel->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
