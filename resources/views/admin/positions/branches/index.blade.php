...
<!-- Title -->
@section('title', config('app.name') . ' ~ ' . trans('pages.positions.branches'))
<!-- Extra Styles -->
@section('extra_css')
    <!---DataTables css-->
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <!-- Breadcrumb -->
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">@lang('pages.positions.branches')</h2>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">@lang('pages.positions.branches')</li>
                </ol>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Table Title -->
                        <div>
                            <h6 class="card-title mb-1">@lang('form.position') @lang('pages.positions.branches')</h6>
                            <p class="text-muted card-sub-title">@lang('pages.positions.branchesTitleNote'):</p>
                        </div>
                        ...
                        <div class="table-responsive mt-2">
                            <table id="exportexample"
                                ...
                                <tr>
                                    ...
                                    <th>@lang('pages.positions.manager')</th>
                                ...
                                @foreach($branches as $branch)
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                            $employee = \App\Models\Employee::where('position_id', $branch->id)->first();
                                            @endphp
                                            @if(!empty($employee))
                                        ...
                                        <td>{{ $branch->position_number }}</td>
                                        <td>{{ \Str::limit($branch->desc, 100, '...') }}</td>

                                        <!-- Action -->
                                        <td>
                                            <!-- Show -->
                                            <a class="btn btn-sm ripple btn-secondary"
                                               href="{{ route('admin.positions.show', $branch->id) }}"
