        ...
        <div class="page-header">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.deposits.index') }}">{{ __('کتاب‌ها') }}</a>
                    </li>
            ...
            <div class="btn btn-list">
                <div class="d-flex">
                    <div class="mr-2">
                        ...
                        @include('admin.deposits.delete')
                    </div>
                    <div class="mr-2">
                        <!-- Edit -->
                        <a class="btn ripple bg-dark btn-sm text-white"
                           href="{{ route('admin.deposits.edit', $book->id) }}">
                            @lang('global.edit')
                    ...
                    <div class="mr-2">
                        <!-- Add -->
                        <a class="btn ripple btn-primary btn-sm" href="{{ route('admin.deposits.create') }}">
                            @lang('global.new')
                    ...
                    <div class="card-body text-center">
                        <div class="main-profile-overview widget-user-image text-center">
                            <div class="main-img-user">
                                <a href="{{ $book->image ?? asset('assets/images/deposits/no-image.png') }}"
                                   target="_blank">
                                    <img alt="image"
                                         src="{{ $book->image ?? asset('assets/images/deposits/no-image.png') }}">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg col-xxl-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <a href="{{ route('admin.members.show', $book->subject->id) }}">
                                            {{ $book->subject->title }}
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg col-xxl-5 mt-4 mt-lg-0 offset-xxl-1">
                                ...
                                <div class="row">
                                    ...
                                    <div
                                        class="col">{{ $book->status == 1 ? trans('global.active') : trans('global.inactive') }}</div>
                                </div>
