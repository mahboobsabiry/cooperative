        ...
        <div class="page-header">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.deposits.index') }}">{{ __('کتاب‌ها') }}</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.deposits.show', $book->id) }}">@lang('global.details')</a></li>
                ...
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div class="">
                            ...
                            <!-- Form -->
                            <form method="post" action="{{ route('admin.deposits.update', $book->id) }}" data-parsley-validate="" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
