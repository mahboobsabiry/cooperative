...
<!-- Title -->
@section('title', config('app.name') . ' ~ ' . 'کارمندان معلق')
<!-- Extra Styles -->
@section('extra_css')
    <!---DataTables css-->
        ...
        <div class="page-header">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">کارمندان معلق</li>
                </ol>
            </div>
                    ...
                    <div class="card-body tab-content h-100">
                        ...
                        <div class="tab-pane active">
                            <div class="main-content-label tx-13 mg-b-20">
                                کارمندان معلق ({{ count($suspended_employees) }})
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered dataTable export-table border-top key-buttons display text-nowrap w-100" style="width: 100%;">
                                    ...
                                    <tbody>
                                    @foreach($suspended_employees as $employee)
                                        <tr>
                                            <td>{{ $employee->id }}</td>
                                            <td>
