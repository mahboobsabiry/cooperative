...
<!-- Title -->
@section('title', 'مکتوب ها - مدیریت عمومی اداری')
<!-- Extra Styles -->
@section('extra_css')
    <!---DataTables css-->
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <!-- Breadcrumb -->
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">مکاتیب مدیریت عمومی اداری</h2>
                <ol class="breadcrumb">
            ...
            <div class="btn btn-list">
                <!-- Add New -->
                @can('asy_user_create')
                    <a class="btn ripple btn-primary" href="{{ route('admin.asycuda.documents.create') }}">
