        ...
        <div class="page-header">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.office.agents.show', $company->agent->id) }}">@lang('global.details')</a></li>
                    <li class="breadcrumb-item active" aria-current="page">تمدید شرکت</li>
                </ol>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h6 class="card-title tx-15 tx-bold mb-1">تمدید شرکت - نماینده ({{ $company->agent->name }})</h6>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="">
                            <!-- Form -->
                            <form method="post" action="{{ route('admin.office.agents.renewal_agent_company', $company->id) }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <!-- Name -->
                                        <div class="form-group">
                                            ...
                                            <p type="text" id="name" class="form-control bg-gray-300 text-dark">{{ $company->agent->name }}</p>
                                        </div>

                                        <!-- Company Name -->
                                        <div class="form-group">
                                            <p class="mb-2">نام شرکت:</p>
                                            <p type="text" id="name" class="form-control bg-gray-300 text-dark">{{ $company->name }} - {{ $company->tin }}</p>
                                        </div>
