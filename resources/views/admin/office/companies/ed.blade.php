...
<div class="modal" id="edit_record{{ $company->id }}">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <!-- Form -->
            <form method="post" action="{{ route('admin.office.companies.update', $company->id) }}" class="" data-parsley-validate="">
                @csrf
                @method('PUT')
...
<!-- Delete -->
<div class="modal" id="delete_record{{ $company->id }}">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <!-- Modal Header -->
            <div class="modal-header">
            ...
            <!-- Form -->
            <form method="post" action="{{ route('admin.office.companies.destroy', $company->id) }}" class="" data-parsley-validate="">
                @csrf
                @method('DELETE')
                <div class="modal-body">
