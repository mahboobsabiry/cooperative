        ...
        <div class="page-header">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.office.companies.index') }}">@lang('pages.companies.companies')</a></li>
                ...
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div class="">
                            ...
                            <!-- Form -->
                            <form method="post" action="{{ route('admin.office.agents.store') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <!-- Name -->
