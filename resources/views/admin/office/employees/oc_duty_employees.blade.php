...
<!-- Title -->
@section('title', 'کارمندان خدمتی از دیگر اداره/ارگان')
<!-- Extra Styles -->
@section('extra_css')
    <!---DataTables css-->
        ...
        <div class="page-header">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">کارمندان خدمتی از اداره/ارگان دیگر</li>
                </ol>
            </div>
                    ...
                    <div class="card-body tab-content h-100">
                        ...
                        <div class="tab-pane active">
                            <div class="main-content-label tx-13 mg-b-20">
                                کارمندان خدمتی از اداره/ارگان دیگر ({{ count($oc_duty_employees) }})
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered dataTable export-table border-top key-buttons display text-nowrap w-100" style="width: 100%;">
                                    ...
                                    <tbody>
                                    @foreach($oc_duty_employees as $employee)
                                        <tr>
                                            <td>{{ $employee->id }}</td>
                                            <td>
