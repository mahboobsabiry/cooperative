...
<!-- Title -->
@section('title', trans('pages.employees.editTitle') . ' - ' . $employee->name)
<!-- Extra Styles -->
@section('extra_css')
    <!---Fileupload css-->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group @error('position') has-danger @enderror">
                                                    ...
                                                    <input type="text" id="position" class="form-control @error('position') form-control-danger @enderror" name="position" value="{{ $employee->position ?? old('position') }}" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group @error('name') has-danger @enderror">
                                                    ...
                                                    <input type="text" id="name" class="form-control @error('name') form-control-danger @enderror" name="name" value="{{ $employee->name ?? old('name') }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group @error('birth_date') has-danger @enderror">
                                                    ...
                                                    <input type="text" data-jdp data-jdp-max-date="today" id="birth_date" class="form-control @error('birth_date') form-control-danger @enderror" name="birth_date" value="{{ $employee->birth_date ?? old('birth_date') }}" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group @error('emp_code') has-danger @enderror">
                                                    <p class="mb-2">6) @lang('form.empNumber'): <span class="tx-danger">*</span></p>
                                                    <input type="text" id="emp_code" class="form-control @error('emp_code') form-control-danger @enderror" name="emp_code" value="{{ $employee->emp_code ?? old('emp_code') }}">
                                        ...
                                        <div class="form-group @error('address') has-danger @enderror">
                                            ...
                                            <input type="text" id="address" class="form-control @error('address') form-control-danger @enderror" name="address" value="{{ $employee->address ?? old('address') }}" required>
